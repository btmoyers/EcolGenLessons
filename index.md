...
>
> This lesson uses the bash shell and a prepared set of files and data. Information on accessing the required data is provided on the [setup page](https://btmoyers.github.io/EcolGenLessons/setup.html).
{: .prereq}
